...
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS(void) configureTimerForRunTimeStats(void)
#define portGET_RUN_TIME_COUNTER_VALUE(void) getRunTimeCounterValue(void)
