...
enum push_type_e Pestate=PUSH_IDLE;
/* \\ \\ \\ \\ \\ \\ \\ || || || || || || // // // // // // // //
\\ \\ \\ \\ \\ \\ \\        _ooOoo_          // // // // // // //
\\ \\ \\ \\ \\ \\          o8888888o            // // // // // //
\\ \\ \\ \\ \\             88" . "88               // // // // //
...
//  the middle line After reSample
AT_DTCM_SECTION_ALIGN(float rptscs0[POINTS_MAX_LEN][2], 8);
AT_DTCM_SECTION_ALIGN(float rptscs1[POINTS_MAX_LEN][2], 8);
//Counter of 
int rptscs0_num, rptscs1_num;
//Long straight
